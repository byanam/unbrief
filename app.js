...
>> Outcome: First Responder Advantage Activated (74% Close Rate)`
  ...
  // ==========================================================================
  // SLOW DOWN HERO GRADIENT VIDEO SPEED
  // ==========================================================================
  const gradientVideo = document.querySelector(".shadergradient-media");
  if (gradientVideo && gradientVideo.tagName === "VIDEO") {
    gradientVideo.playbackRate = 0.35;
  }
